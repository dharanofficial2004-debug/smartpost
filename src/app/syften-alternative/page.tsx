...
export const metadata = constructMetadata({
  title: "Syften Alternative | SmartPost",
  description: "Find customers automatically with our syften alternative platform. SmartPost uses AI to find high-intent leads on Reddit.",
  canonicalUrl: "/syften-alternative",
});

export default function Page() {
  const data = pseoPages.find(p => p.slug === "syften-alternative");
  if (!data) throw new Error('PSEO data not found for syften-alternative');
  const {
    headline,
    subheadline,
    ctaButton,
  ...
  return (
    <>
      ...
      <PSEOPageTemplate
        redditTool={
          <RedditOutreachTool 
            defaultKeyword="syften alternative"
            pageContext="syften-alternative"
          />
        }
        hero={hero}
